public class LorumIpsumStringMethods
{
    ...
    {   
        ...
        //boolean to check if trim is equal to goat
        System.out.println(trimLorum.equals("goat"));
        //booleanm to check if trim is equal to original lorum
        System.out.println(trimLorum.equals(lorum));
        //boolean to check if trim is equal to trim
